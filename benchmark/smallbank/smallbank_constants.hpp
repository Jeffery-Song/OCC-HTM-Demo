...
bool     SmallBankConstants::ENABLE_HOTSPOT             = false; // 0-100
uint32_t SmallBankConstants::HOTSPOT_PROB               = 10; // 0-100
uint32_t SmallBankConstants::HOTSPOT_FIXED_SIZE         = 100; // fixed number of tuples
...
uint32_t SmallBankConstants::NUM_CLIENTS                = 8;
uint64_t SmallBankConstants::RUN_TIME_SEC               = 10;
